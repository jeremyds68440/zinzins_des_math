...
public class MoyenActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView infoMultifactor = findViewById(R.id.info_multifactor_moyen);
        ImageView infoMathemaquizz = findViewById(R.id.info_mathemaquizz_moyen);
        ImageView infoRoulette = findViewById(R.id.info_roulette_moyen);
