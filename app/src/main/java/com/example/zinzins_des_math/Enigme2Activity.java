...
public class Enigme2Activity extends AppCompatActivity {
    ...
    private Enigme2Activity enigme2Activity = this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submit_answer_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(Enigme2Activity.this, "Réponse soumise", Toast.LENGTH_SHORT).show();
        ...
        explication.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder expli = new AlertDialog.Builder(enigme2Activity);
