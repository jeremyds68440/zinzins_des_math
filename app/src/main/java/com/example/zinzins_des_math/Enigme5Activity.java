...
public class Enigme5Activity extends AppCompatActivity {
    ...
    private Enigme5Activity enigme5Activity = this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submit_answer_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(Enigme5Activity.this, "Réponse soumise", Toast.LENGTH_SHORT).show();
        ...
        explication.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder expli = new AlertDialog.Builder(enigme5Activity);
